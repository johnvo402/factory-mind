...
- **Decision:** Application exposes the AI response as `IAsyncEnumerable<string>`; Presentation serializes it as Server-Sent Events, while Infrastructure implements the provider streaming protocol.
...
- **Date:** 2026-07-31
- **Provider update:** The original OpenAI-compatible implementation is superseded by decision 0027; the Application and Presentation boundaries remain unchanged.
